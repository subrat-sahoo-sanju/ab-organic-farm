<section class="relative overflow-hidden bg-gradient-to-br from-[#0C831F] via-[#146B28] to-[#0C3D22] py-14">
  <div class="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-white/10 blur-3xl"></div>
  <div class="pointer-events-none absolute -bottom-16 -right-16 h-64 w-64 rounded-full bg-[#74C9A1]/20 blur-3xl"></div>
  <div class="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
    ...
    <div class="mt-8 flex flex-wrap items-center justify-center gap-4">
      <a href="{{ setting('home.cta_link', route('shop.categories')) }}" class="inline-flex items-center gap-2 rounded-xl bg-white px-7 py-3.5 text-sm font-bold text-[#0C831F] shadow-lg transition hover:bg-[#74C9A1]">
