<style>
  ...
  .menu-main-heading{font-size:1.9rem;font-weight:700;line-height:1.2;margin:0 0 .5rem;color:#1F5C3F;text-align:center}
  .menu-subheading{font-size:1.9rem;font-weight:400;line-height:1.2;margin:0 0 2rem;color:#1F5C3F;text-align:center}
  ...
  .sliding-indicator{position:absolute;bottom:0;left:0;height:4px;background:#1F5C3F!important;border-radius:2px 2px 0 0;transition:transform .3s cubic-bezier(.4,0,.2,1),width .3s cubic-bezier(.4,0,.2,1),opacity .2s ease;z-index:1;opacity:0;box-shadow:0 -1px 3px #1F5C3F33;min-width:20px!important;visibility:visible!important;pointer-events:none}
